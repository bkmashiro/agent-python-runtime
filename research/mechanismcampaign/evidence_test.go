...
func validUnifiedEvidence(t *testing.T) Evidence {
	...
	events := []Event{
		...
		{Type: "capsule.bind", ActorID: "host", LogicalID: "oxford", IdentitySHA256: digest, Outcome: "bound"},
	...
	full := FullRunEvidence{
		...
		Candidates: map[string]CandidateEvidence{
			"brighton": {TotalCostGBP: 118.4, SourceSHA256: digest, PhysicalIssues: 3, LogicalClaims: 3, SourceSealed: true, COWSelected: true},
			"oxford":   {TotalCostGBP: 78, SourceSHA256: digest, PhysicalIssues: 3, LogicalClaims: 3, SourceSealed: true, COWSelected: true},
		},
		...
		MainSelected: "oxford", MainTotalGBP: 78, ColdWaits: 1, ColdSucceeded: 1, PageOutSucceeded: 1,
