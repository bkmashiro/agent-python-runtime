...
- cgroup v2 scope and anonymized membership identity; point-in-time current/swap are measured only for a process-dedicated scope, while peak/event/pressure counters require an explicit baseline.
