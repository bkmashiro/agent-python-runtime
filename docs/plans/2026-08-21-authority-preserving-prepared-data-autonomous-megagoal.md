...
- 2026-08-21: The P4 full-derived-image correctness slice is proven at clean mechanism target `4368d80fb541b011fd8c15982744871a5e94aa10` (`tree 2ded8ccfecc278d8dd17a70bb49669ba6f9eb97c`). The exact 8 MiB body is decoded into one prepared NumPy ndarray before sealing a 176357376-byte image. Fresh Linux consumers use `MAP_PRIVATE`, transfer zero body bytes per consumer, report only minor page faults, and A's write is absent from B; the Host backing is sealed and no pointer/FD is exposed. The observed 9.66 s combines one-time package-shard preparation with dataset derivation and is therefore not a valid per-load cost; it remains mechanism evidence only. P4 must rerun with the package baseline prepared once and dataset derivation timed separately. Body-safe evidence identity is `sha256:ac53301bae842f517e322bc74515b2590afa484afa04fb82bc47d982b7bd53d7`. P4 remains open until the 1/2/4 harness and private-copy/recompute controls join in P5; no generic allocator or page-composed path was added.
