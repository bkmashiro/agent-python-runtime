...
- **P6, final-review candidate complete:** `e87f77457761f7e578ef2a46fa9f0df6af8b19d4` (`tree df84aae57dc50155023c238da20812e11962eed8`) closes the Host-generated producer declarations and binds opaque Exact Guest analysis, admission provenance, concrete-Wazero execution, and prepared-lineage identity. The prior `7147b14` review correctly failed forged publication/admission, `EffectFree` overclaim, mutable request/consumer lineage, and body-safe checking. Publication and admission tokens are now identity-bound internal seals; lineage stores `ConsumerSourceSHA256`, recomputes `Digest(plan.Request)`, and rejects copied-token mutations. `EffectFree` representation is absent; native-call unknown remains unknown and no DBI/purity claim is made. The immutable `numpy-core` artifact remains `sha256:2753cde560f3961a483df53aec334c8fdbb084934e5a62a56d436aea1ae557ad`. Clean-source probe commit `5d7a6d7dc8a5ad50017748e1158a086305345b09` produced macOS evidence `sha256:3530868d5b4cc1b3cc45a80f0a4151d737b87d0d8c8847c014f554844c806c19` and Linux evidence `sha256:f9840f4e9be0127d85446e200b70d0ea03868a0e56b9d437148711aee1d15330`.
- **Next:** obtain an independent fixed-target review of `e87f774`/`5d7a6d7`, then restart P7 from zero. All earlier campaign records remain invalidated; no timing from P2/P5/P6 is admitted into the frozen economics campaign.
