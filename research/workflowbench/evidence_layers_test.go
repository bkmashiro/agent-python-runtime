...
func validEvidenceSuite() EvidenceSuite {
	...
	return EvidenceSuite{SchemaVersion: EvidenceSuiteSchema, SuiteID: "workflow-evidence-v1", Workloads: []EvidenceWorkload{
		{
			ID: "natural-tau2-read", Layer: EvidenceNaturalCensus, Origin: "natural_benchmark",
		...
		{
			ID: "trace-read-fan-in", Layer: EvidenceTraceDAG, Origin: "private_trace_projection",
		...
		{
			ID: "stress-shared-substrate", Layer: EvidenceMechanism, Origin: "authored_mechanism_case", OptimizationRequired: true,
