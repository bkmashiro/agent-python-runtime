...
- **P6, second post-review candidate complete:** `9afa98710429f50ffb21f529cd2c80c2630199ae` (`tree b1884f1791361cbe57fe1e098f8fc1666f031719`) closes the Host-generated producer declarations and binds three opaque Host credentials: Exact Guest analysis, admission provenance and concrete-Wazero execution. The prior `7147b14` independent review correctly failed four boundaries: forged publication guards, forged public admissions, unknown native effects being promoted to `EffectFree`, and a body-safe checker that accepted injected raw fields. The current candidate makes publication authority an internal-package token, rejects zero/fabricated admissions, removes the `EffectFree` representation entirely, and uses strict top-level/body-key/length evidence checks. Conservative native-call unknowns remain recorded as unknown and are not DBI or a purity certificate. Publication claims only a validated value from the closed deterministic declaration under locked artifact/profile, stable pre/post engine properties, no workspace or capability broker, successful terminal response, zero capability calls and exact source binding. Prepared lineage reconstructs its decision binding and joins consumer, final source, inputs and request identities. The immutable `numpy-core` artifact remains `sha256:2753cde560f3961a483df53aec334c8fdbb084934e5a62a56d436aea1ae557ad`. New macOS and Linux evidence identities are `sha256:4e32be20399c93eb89f153ef49478661abf0f05da35aa448bad2286e5ac41a27` and `sha256:cde85daaf6a1b284e117f336dcb61abaa7c4742a609a99946747443fbc19b1da`.
- **Next:** obtain an independent fixed-target review of `9afa987`, then restart P7 from zero. All earlier campaign records remain invalidated; no timing from P2/P5/P6 is admitted into the frozen economics campaign.
