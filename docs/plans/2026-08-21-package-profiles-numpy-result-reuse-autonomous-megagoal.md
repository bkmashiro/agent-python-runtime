...
- **P6, post-review candidate complete:** `7147b142d2d1eda79f4ef34d017510098406118c` (`tree 0fee7ad1b8fa6be3ec865188bfb5f8fd095565b4`) closes the Host-generated producer declarations and requires opaque Exact Guest analysis plus concrete-Wazero execution provenance. Conservative native-call unknowns remain recorded as unknown; they are not treated as DBI or a purity certificate. Publication is admitted only for the locked artifact/profile with stable pre/post engine properties, no workspace or capability broker, successful terminal response, zero capability calls and exact source binding. Prepared lineage reconstructs its decision binding and joins consumer, final source, inputs and request identities. The immutable `numpy-core` artifact is `sha256:2753cde560f3961a483df53aec334c8fdbb084934e5a62a56d436aea1ae557ad`; the Phase 2 artifact remains untouched. The post-review macOS and Linux evidence identities are `sha256:b5344e0840d642cc56ed7c05b58cb6bd499534283a7499614ff46114b162bc30` and `sha256:b0b2bc5c6bfe7538df6f33e14782fea7d00c95cbe8cf9207891edf6ad5191d77`.
- **Next:** await the fixed-target P6 independent review, then restart P7 from zero. All campaign records produced before the provenance fix are invalidated; no timing from P2/P5/P6 is admitted into the frozen economics campaign.
