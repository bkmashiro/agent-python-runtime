...
func TestExecuteExportsStrictDigestOnlyEvidence(t *testing.T) {
	...
	schemaData, err := os.ReadFile("../../abi/v1/transaction-evidence-v3.schema.json")
	if err != nil {
		t.Fatal(err)
	}
	...
	const schemaURL = "https://agent-runtime.dev/abi/v1/transaction-evidence-v3.schema.json"
