...
usage: scripts/test-host-workstation.sh \
  --suite baseline|prepared-family|evaluation|evaluation-sweeps|plm-fixed-cost|source-stream-timing|plm-prefix-scaling|thesis-experiments \
...
case "$suite" in baseline|prepared-family|evaluation|evaluation-sweeps|plm-fixed-cost|source-stream-timing|plm-prefix-scaling|thesis-experiments) ;; *) usage >&2; exit 2 ;; esac
