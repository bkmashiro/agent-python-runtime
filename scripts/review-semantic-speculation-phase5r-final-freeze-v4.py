...
HARNESS = ROOT / "docs/evidence/semantic-speculation-phase5r-harness-freeze-v4.json"
ARTIFACT = ROOT / "docs/evidence/semantic-speculation-phase5r-guest-artifact-freeze-v3.json"
EXPECTED_IDENTITY = "sha256:0f929b9b6040cde4d6e0e53805059122584a12a1f250b1aa77c8d632779144e4"
...
assert harness["schema_version"] == "pysolate.semantic-speculation-phase5r-harness-freeze.v4"
...
assert source["schema_version"] == "pysolate.semantic-speculation-phase5r-harness-source-set.v4"
