...
func ValidateTrialResult(result TrialResult) error {
	...
	routerTrial := result.Condition == ConditionHybrid && (result.TreatmentID == TreatmentHybridTwoStageRouterV1 || result.TreatmentID == TreatmentHybridTwoStageSafeRepairV2 || result.TreatmentID == TreatmentHybridTwoStagePreboundCompactV3 || result.TreatmentID == TreatmentHybridTwoStagePreboundCompactJSONV4)
	if result.Route != nil {
		if !routerTrial {
			return ErrTrialArtifact
		}
	...
	compactPythonTreatment := result.TreatmentID == TreatmentHybridTwoStagePreboundCompactV3 || result.TreatmentID == TreatmentHybridTwoStagePreboundCompactJSONV4
	...
	repairTreatment := result.TreatmentID == TreatmentPythonSafeRepairV1 || result.TreatmentID == TreatmentHybridTwoStageSafeRepairV2 || result.TreatmentID == TreatmentHybridTwoStagePreboundCompactV3 || result.TreatmentID == TreatmentHybridTwoStagePreboundCompactJSONV4
	if !repairTreatment {
