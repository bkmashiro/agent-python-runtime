...
func (s *Store) BeginCall(ctx context.Context, runID string, call capability.LoggedCall) (Call, bool, error) {
...
func callPayload(call capability.LoggedCall, operationKey string) uint64 {
